...
with col1:
    ...
    st.image("restaurante/imagenes/sanques.png",width=200)
    st.title("$50")
...
with col2:
    ...
    min_value=0,max_value=10,value=0)
    st.image("restaurante/imagenes/defna.png",width=200)
    st.title("$65")
...
with col3:
    ...
    min_value=0,max_value=10,value=0)
    st.image("restaurante/imagenes/wn.png",width=200)
    st.title("$60")
...
with col4:
    ...
    min_value=0,max_value=10,value=0)
    st.image("restaurante/imagenes/wp.png",width=200)
    st.title("$65")
...
with col5:
    ...
    min_value=0,max_value=10,value=0)
    st.image("restaurante/imagenes/naps.png",width=200)
    st.title("$30")
...
with col6:
    ...
    min_value=0,max_value=10,value=0)
    st.image("restaurante/imagenes/pora.png",width=200)
    st.title("$40")
